...
export async function executeBridgeRequest(raw: unknown, auth: Awaited<ReturnType<typeof authenticateBridgeRequest>>) {
  ...
  switch (request.operation) {
    ...
    case "propose_profile_update": result = await queueSyncItem({ type: "profile_update", external_id: request.external_id, canonical_key: request.canonical_key, name: request.name, primary_email: request.primary_email, phone: request.phone, portfolio_url: request.portfolio_url, assertion_state: "proposed", supports: true, source: request.source }, "chatgpt", auth.client.name); break;
    case "propose_education": result = await queueSyncItem({ type: "education_proposal", external_id: request.external_id, canonical_key: request.canonical_key, institution: request.institution, degree: request.degree, major: request.major, concentration: request.concentration, graduation_date: request.graduation_date, gpa: request.gpa, assertion_state: "proposed", supports: true, source: request.source }, "chatgpt", auth.client.name); break;
    case "propose_experience": result = await queueSyncItem({ type: "experience_proposal", external_id: request.external_id, canonical_key: request.canonical_key, employer: request.employer, title: request.title, location: request.location, start_date: request.start_date, end_date: request.end_date, is_current: request.is_current, responsibilities: request.responsibilities, assertion_state: "proposed", supports: true, source: request.source }, "chatgpt", auth.client.name); break;
    case "propose_project": result = await queueSyncItem({ type: "project_proposal", external_id: request.external_id, canonical_key: request.canonical_key, project_name: request.project_name, project_status: request.project_status, project_url: request.project_url, technologies: request.technologies, summary: request.summary, assertion_state: "proposed", supports: true, source: request.source }, "chatgpt", auth.client.name); break;
    case "propose_skills": result = await queueSyncItem({ type: "skill_proposal", external_id: request.external_id, canonical_key: request.canonical_key, skills: request.skills, assertion_state: "proposed", supports: true, source: request.source }, "chatgpt", auth.client.name); break;
    case "propose_claim":
